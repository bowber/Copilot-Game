...
describe('App Component', () => {
  it('renders the game title and description', () => {
    ...
    expect(screen.getByText('A Rust + WASM game with SolidJS frontend')).toBeInTheDocument();
  });
  ...
  it('renders game features list', () => {
    ...
    expect(screen.getByText('Physics-based ball movement with collision detection')).toBeInTheDocument();
  });

  it('shows technical details', () => {
    render(() => <App />);
    
    expect(screen.getByText(/The game engine is written entirely in Rust/)).toBeInTheDocument();
...
describe('Component Structure', () => {
  ...
  it('has proper styling classes', () => {
    ...
    expect(screen.getByText('Start/Resume').parentElement).toHaveClass('controls');
  });
});